...
from (values
  ...
  ('Germany', 21), ('Curaçao', 8), ('Côte d''Ivoire', 12), ('Ecuador', 16),
  ('Netherlands', 20), ('Japan', 15), ('Sweden', 12), ('Tunisia', 10),
  ...
  ('Portugal', 20), ('Colombia', 17), ('Uzbekistan', 12), ('Congo DR', 9),
  ('England', 21), ('Croatia', 17), ('Ghana', 7), ('Panama', 12)
